                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            ...
                            <div className="flex gap-1 mb-6">
                                {[...Array(5)].map((_, i) => (
                                    <Star 
                                        key={i} 
                                        className={`w-5 h-5 ${i < testimonials[currentIndex].rating ? 'text-primary fill-primary' : 'text-slate-700'}`} 
                                    />
                                ))}
                            </div>
                            ...
                            <div className="flex flex-col items-center gap-1">
                                <h4 className="text-lg font-bold text-white tracking-wide">{testimonials[currentIndex].name}</h4>
